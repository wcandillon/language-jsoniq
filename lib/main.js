...
function updateStatusbar() {
  ...
  if(error) {
    atom.workspaceView.statusBar.appendLeft('<span id="xqlint-statusbar" class="inline-block">line ' + (error.pos.sl + 1) + ': ' + (error.message > 140 ? (error.message.substring(0, 140) + '...') : error.message) + '</span>');
  }
}
